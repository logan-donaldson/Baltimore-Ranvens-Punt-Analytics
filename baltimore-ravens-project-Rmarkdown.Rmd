...
Here we check if the residuals have non-constant variance. we find that they do and we will attempt to address this through remidial measures later.
...
Here we check if the residuals are normally distributed but they are clearly not. Again we will attempt to address this later through remidial measures.
...
We then perform a transformation similar to the ones we had already done. With the new tranformation we check out assumptions again, just as we had done previously.
